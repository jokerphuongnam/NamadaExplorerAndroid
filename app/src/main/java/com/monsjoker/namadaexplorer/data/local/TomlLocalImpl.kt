...
@Singleton
class TomlLocalImpl @Inject constructor(
    private val toml: Toml,
    @ApplicationContext private val context: Context,
) : TomlLocal {
    override suspend fun readParameters(): TomlData {
        toml.read(context.resources.openRawResource(R.raw.parameters))
        return TomlData(
            parameters = TomlData.Parameters(
            ...
            minimumGasPrice = TomlData.MinimumGasPriceParams(
